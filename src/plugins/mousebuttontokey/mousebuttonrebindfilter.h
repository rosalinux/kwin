...
class MouseButtonRebindFilter : public KWin::Plugin, public KWin::InputEventFilter
{
    Q_OBJECT
public:
    explicit MouseButtonRebindFilter(QObject *parent = nullptr);
...
private:
    ...
    QMap<Qt::MouseButton, QKeySequence> m_buttonMapping;
