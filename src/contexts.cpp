...
QVector<ContextInstance *> ContextInstance::s_contextInstances = QVector<ContextInstance *>();
...
{
    s_contextInstances.removeOne(this);
...
{
    m_rootContextInstance = std::make_shared<ContextInstance>(DEFAULT_CONTEXT, "Root Context");
