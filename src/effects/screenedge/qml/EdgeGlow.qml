...
Item {
    ...
    PlasmaCore.Svg {
        ...
        function updateSize(item) {
            const size = elementSize(item.elementId);
            item.Layout.preferredWidth = size.width;
            item.Layout.preferredHeight = size.height;
        }
    }
    ...
    GridLayout {
        ...
        PlasmaCore.SvgItem {
            id: leadingItem
            svg: glowSvg
            Component.onCompleted: glowSvg.updateSize(this)
        }
