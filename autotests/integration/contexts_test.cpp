...
static const QString s_socketName = QStringLiteral("contexts-0");
...
private Q_SLOTS:
    ...
    void contextSwitchAlwaysSuppliesActivationParameters();
...
void ContextsTest::contextSwitchAlwaysSuppliesActivationParameters()
{
    ...
    QList<Parameter> requiredParams;
